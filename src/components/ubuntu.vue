<template>
  <div>
      ...
      <Card>
        <Row gutter="230">
          ...
          <Row>
            ...
            <b-btn size="sm" class="add" v-b-modal.modalPrevent5><span class="icon-plus"></span></b-btn>
    ...
    <b-modal id="modalPrevent5" title="Separate multiple resource name with commas" ref="modal" @ok="handleOk" @shown="clearName">
