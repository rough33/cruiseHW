<template>
  <div>
      ...
      <Card>
        <Row gutter="230">
          ...
          <Row>
            ...
            <b-btn size="sm" class="add" v-b-modal.modalPrevent4><span class="icon-plus"></span></b-btn>
    ...
    <b-modal id="modalPrevent4" ref="modal" @ok="handleOk" @shown="clearName" title="Separate multiple resource name with commas">
